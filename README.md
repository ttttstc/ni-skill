...
| Diagnosis | [`ni-unknown-ladder`](./skills/ni-unknown-ladder) | Diagnose which kind of "unknown" you are facing and emit a Chinese next-step prompt |
...
- Diagnose which "unknown" you're facing and get a next-step prompt → `ni-unknown-ladder`
